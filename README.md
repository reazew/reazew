...
Dedicated to building scalable, high-performance, and well-architected frontend applications.

I am a front-end developer focused on React, Next.js, Vite, and TypeScript, with strong experience in **Frontend Architecture Patterns**, **Microfrontends**, **State Management**, **TDD**, **Unit Testing**, and **Performance Optimization**.
